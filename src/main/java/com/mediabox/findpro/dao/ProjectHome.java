...
import com.mediabox.findpro.data.Project;

/**
 * Home object for domain model class Project.
 * @see com.mediabox.findpro.dao.Project
	...
	public Project findById(java.lang.String id) {
		...
		try {
			Project instance = (Project) sessionFactory.getCurrentSession()
					.get("com.mediabox.findpro.dao.Project", id);
			if (instance == null) {
	...
	public List findByExample(Project instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.mediabox.findpro.dao.Project")
