...
import com.mediabox.findpro.data.Company;

/**
 * Home object for domain model class Company.
 * @see com.mediabox.findpro.dao.Company
	...
	public Company findById(java.lang.Integer id) {
		...
		try {
			Company instance = (Company) sessionFactory.getCurrentSession()
					.get("com.mediabox.findpro.dao.Company", id);
			if (instance == null) {
	...
	public List findByExample(Company instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.mediabox.findpro.dao.Company")
